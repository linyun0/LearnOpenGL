...
unsigned int TextureFromFile(const char* path, const string& directory, bool gamma = false, QOpenGLFunctions_3_3_Core* glFuncs=nullptr);
    ...
    vector<Texture> loadMaterialTextures(aiMaterial* mat, aiTextureType type, string typeName)
    {
        ...
        for (unsigned int i = 0; i < mat->GetTextureCount(type); i++)
        {
            ...
            {   // if texture hasn't been loaded already, load it
                Texture texture;
                texture.id = TextureFromFile(str.C_Str(), this->directory,false,glFuncs);
...
unsigned int TextureFromFile(const char* path, const string& directory, bool gamma, QOpenGLFunctions_3_3_Core* glFuncs)
{
    ...
    if (data)
    {
        ...
        glFuncs->glTexImage2D(GL_TEXTURE_2D, 0, format, width, height, 0, format, GL_UNSIGNED_BYTE, data);
